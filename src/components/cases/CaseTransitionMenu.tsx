...
export function CaseTransitionMenu({ caseId, currentStatus }: Props) {
  ...
  return (
    <form onSubmit={handleTransition} className="space-y-4 p-4 border rounded-lg bg-gray-50 dark:bg-gray-800/50 dark:border-gray-700">
      <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">Update Case Status</h3>
      ...
      <div className="flex flex-col gap-3">
        <select
          ...
          className="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm text-gray-900 dark:text-gray-100 px-3 py-2 border"
          disabled={loading}
        >
