...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isFullWidth, isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      ghost: 'bg-transparent text-text-primary hover:bg-surface-hover active:bg-surface-muted border border-transparent',
    };
