...
create policy refunds_select_member
on public.refunds
for select
to authenticated
using ((select private.is_workspace_member(workspace_id)));

create policy refunds_insert_member
on public.refunds
for insert
to authenticated
with check ((select private.is_workspace_member(workspace_id)));

create policy refunds_update_member
on public.refunds
for update
to authenticated
using ((select private.is_workspace_member(workspace_id)))
...
create policy tax_events_select_member
on public.tax_events
for select
to authenticated
using ((select private.is_workspace_member(workspace_id)));

create policy tax_events_insert_member
on public.tax_events
for insert
to authenticated
with check ((select private.is_workspace_member(workspace_id)));

create policy tax_events_update_member
on public.tax_events
for update
to authenticated
using ((select private.is_workspace_member(workspace_id)))
...
create policy communications_select_member
on public.communications
for select
to authenticated
using ((select private.is_workspace_member(workspace_id)));

create policy communications_insert_member
on public.communications
for insert
to authenticated
with check (
