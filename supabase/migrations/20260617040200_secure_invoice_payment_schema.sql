...
grant update (status, issue_date, due_date, discount_amount, notes, archived_at) on table public.invoices to authenticated;
grant select, insert, delete on table public.invoice_items to authenticated;
grant update (description, quantity, unit_amount, display_order) on table public.invoice_items to authenticated;
grant select, insert on table public.payments to authenticated;
grant update (reversed_at) on table public.payments to authenticated;
