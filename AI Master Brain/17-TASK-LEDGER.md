...
| GUIDED-WORKFLOW-01 | DONE | Implement Guided Workflow Engine and simplify operational statuses | DASHBOARD-EXCEPTIONS-01 | Client journey dashboard, 8-step pipeline rail, status cleanup to 3 states, embedded charges table | `06aa20f` |
